...
export class UserService {
    ...
    constructor(private http: HttpClient, private loginService: LoginService, private toastsService: ToastService, private localStorageService: LocalStorageService) {
    }
