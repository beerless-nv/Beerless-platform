...
requires: {
    "searchParams": [
        ...
        <h3><a id="user-content-get-a-specific-value-from-a-row" class="anchor" aria-hidden="true"
            ...
            </a>Get a specific value from a row
        </h3>
        <p>If you'd like to get a single value from a specific row in a table, you can achieve this by using a query
            parameter. Add the parameter 'value' and specify which value you want to get from the database:</p>
        <pre><code>GET /beers/beerId?value=ABV
</code></pre>
